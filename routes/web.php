...
//ROUTES VISITA DOMICILIARIA
Route::resource('visitadomiciliaria','visitaDomiciliariaController')->except('destroy');
Route::post('visitadomiciliaria.search','visitaDomiciliariaController@search')->name('visitaDomiciliaria.search');
Route::get('visitadomiciliaria/id', 'visitaDomiciliariaController@sideface')->name('visitaDomiciliaria/id');
